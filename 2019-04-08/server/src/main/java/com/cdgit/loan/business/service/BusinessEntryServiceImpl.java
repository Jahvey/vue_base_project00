...
//		String procInstId = (String)pendingTaskMap.get("procInstId");
	 ...
	 * <p>Title: getEnumsValue</p>  
	
	 * <p>Description: </p>  
	
	 * @return
	 */
	public List<Map<String,Object>> getEnumsValue(String dicttypeid){
		
    	return queryMapper.getEnumsValue(dicttypeid);
	}
	 ...
	 * @return
	 */
	public List<Map<String,Object>> queryOmPosition(String legorg){
		
    	return queryMapper.queryOmPosition(legorg);
	}

    ...
    return {
      ...
      pageDef: {
        ...
        tabDef: {
          ...
          // 表格字段定义
          tabCols: [
            { label: '收费种类', prop: 'chargingType', isSort: true, isFormat: true, enumType: 'chargingTypeCd' },
            { label: '收费比例（‰）', prop: 'chargingProportion', isSort: true },
            { label: '收费金额', prop: 'shouldFee', isSort: true },
            { label: '收费方式', prop: 'costType', isSort: true, isFormat: true, enumType: 'costTypeCd' }
          ]
        },
        buttons: [

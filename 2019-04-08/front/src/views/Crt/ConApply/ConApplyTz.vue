...
-->
    ...
    <conTree :paramsInfo="paramsInfo"
             v-if="paramsInfo.conTreeVisiable"></conTree>
    ...
    <el-dialog width="95%"
      ...
      <conApplyYwht :paramsConApplyTz="paramsConApplyTz"
                    @openConTree="openConTree"
...
import conTree from '@/views/Csm/ConInfo/ConTree'
import conApplyYwht from '@/views/Crt/ConApply/ConApplyYwht'
...
export default {
  ...
  methods: {
    ...
    getContractBizType(contractId, flag) {
      ...
      const params = { contractId: contractId, flag: flag, bizType: '' }
    ...
    recounted(contractId, flag, bizType) {
      ...
      const params = { contractId: contractId, flag: flag }

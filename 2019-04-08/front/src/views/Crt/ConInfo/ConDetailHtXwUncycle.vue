    ...
    <el-form label-width="200px"
          ...
          <div id="tqhk"
            ...
            <el-col :span="12">
              <el-form-item label="提前还款是否收取违约金:"
                ...
                <el-select v-model="tbConContractInfo.prepaymentPenalty"
                           style="width:100%"
                           @change="onselectPrepaymentPenalty">
            ...
            <el-col :span="12"
              ...
              <el-form-item label="违约金比例%:"
                            ...
                            class="special-input">
                <el-input-number v-model="tbConContractInfo.prepayMakeupRate"
      ...
      <div columns="1"
        ...
        <fieldset>
          ...
          <BizPublicRateXw :conDetailHtData="conDetailHtData"
                           v-show="conDetailHtData.visiable"></BizPublicRateXw>
...
import BizPublicRateXw from '@/views/Biz/BizProductDetail/ConDetailHt/BizPublicRateXw'
...
export default {
  ...
  props: {
    paramsConTree: {// 接受来自conTree的各种参数
  ...
  data() {
    return {
      disAttachedForm: false, // 控制整个页面是否禁用
      ...
      prepaymentPenalty: enums.YesOrNoCd,
      rules: {
  ...
  created() {
    ...
    console.log('成功接受从conTree传入的参数' + JSON.stringify(params))
  ...
  methods: {
    ...
    initPage() {
      ...
      getConDetailInfoByContractId(json).then((response) => {
        ...
        this.tbConContractInfo.prepaymentPenalty = this.o.tbConContractInfo.prepaymentPenalty
        this.tbConContractInfo.prepayMakeupRate = this.o.tbConContractInfo.prepayMakeupRate
    ...
    // 动态列表点击新增
    add(gr) {
      console.log('[add] gr' + gr)
    },
    // 动态列表删除操作
    remove(gr) {
      console.log('[remove] gr' + gr)
    },
    ...
    save() {
      ...
      // TODO 节假日 2019/3/29
      console.log('TODO 节假日与宽限期只能使用一种!')
      ...
      if (this.tbConContractInfo.payWay != null) {
        var zffs = this.tbConContractInfo.payWay
        if (zffs != '1') { // 1是受托

        }
      }
      // var o = form.getData()
      // this.PayoutPlans = nui.get('grid1').getChanges()/* 提款 */
      // this.repayPlans = nui.get('grid2').getChanges()/* 还款 */
      // // 费用信息
      // this.fees = nui.get('grid3').getChanges()/* 费用 */

      console.log('提款 PayoutPlans' + this.PayoutPlans)
      console.log('还款 repayPlans ' + this.repayPlans)
      ...
      saveConContractDetailInfo(this.o).then((response) => {
    ...
    onselectPrepaymentPenalty(e) { // 是否显示违约金比例
      console.log('[onselectPrepaymentPenalty] e is' + e)
      if (this.tbConContractInfo.prepaymentPenalty == '1') {
        this.isPrepayMakeupRate = true
      } else {
        this.isPrepayMakeupRate = false

        this.tbConContractInfo.prepayMakeupRate = ''
      }
    }

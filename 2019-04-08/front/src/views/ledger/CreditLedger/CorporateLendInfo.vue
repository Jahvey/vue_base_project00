...
<script>
  ...
  import {queryCorporateLendInfo} from '@/api/Ledger'
  export default {
    name: "corporate-lend-info",
    data() {
      return {
        entity: {},
    ...
    methods: {
      doPageQuery(listQuery) {
        this.queryCorporateLendInfo(listQuery)
      },

      queryCorporateLendInfo(listQuery) {
        queryCorporateLendInfo(listQuery).then(response => {

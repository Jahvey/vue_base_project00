...
<script>
  ...
  import {queryMicCentreFirstCheck} from '@/api/Afterloan'
  export default {
    name: "micCentreFirstCheck",
    data() {
      return {
    ...
    methods: {
      doPageQuery(listQuery) {
        this.queryMicCentreFirstCheck(listQuery)
      },

      queryMicCentreFirstCheck(listQuery) {
        queryMicCentreFirstCheck(listQuery).then(response => {

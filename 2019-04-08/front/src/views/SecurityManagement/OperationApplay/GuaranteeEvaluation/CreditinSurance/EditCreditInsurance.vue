      ...
      beforeMount(){
        ...
        getTbGrtCreditsafeBySuretyId(this.info).then(response =>{
          if(response.data.flag == enums.stateCode.flag.success) {//
            console.log(JSON.stringify(response.data.grtCollateral));
            this.data.guaranteeType = response.data.grtCollateral.mpType;
            this.data.suretyId = response.data.grtCollateral.guarantyId;
            this.data.partyId = response.data.grtCollateral.customerNum;

        ...
        <el-form el-form label-width="200px"  size="mini" :model="data" label-position="right" :rules="rules" ref="validate" >
          <el-row>
            ...
            <template v-if="data.ifTopSubcon =='0' || data.ifTopSubcon =='' || data.ifTopSubcon==null ">
              <el-col :span="9">
                <el-form-item label="抵押合同金额" prop="subcontractAmt">
            ...
            <template v-if="data.ifTopSubcon =='1'">
              <el-col :span="9">
                <el-form-item label="抵押最高本金限额" prop="zgbjxe">
                  <el-input :disabled="inputComponentDisable" v-model="data.zgbjxe"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="9":offset="3" >
                <el-form-item label="抵押额度起期" prop="beginDate" >
              ...
              <el-col :span="9" >
                <el-form-item label="抵押额度止期" prop="endDate" >
    ...
    export default {
      ...
      data(){
        return{
          ...
          data:{
            subcontractNum:"",//抵押合同编号
            partyName:"",//抵押人名称
            paperConNum:"",//抵押合同纸质编号
            ifTopSubcon:"",//是否最高额抵押
            bz:"",//币种
            subcontractAmt:"",//抵押合同金额
            zgbjxe:"",//抵押最高本金限额
            beginDate:"",//抵押额度起期
            endDate:"",//抵押额度止期
            signDate:"",//签订日期

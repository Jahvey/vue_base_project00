  ...
  <div class="app-biz-info-edit">
      ...
      <el-form el-form ref="updateBizInfoValidate" label-width="200px" :model="bizInfo" label-position="right" :rules="rules" >
        ...
        <el-col :span="12">
          <el-form-item label="业务类型" prop="bizHappenType" >
            <el-select  v-model="bizInfo.bizHappenType" disabled placeholder="请选择" style="width:100%">
        ...
        <el-col :span="12">
          <el-form-item label="业务编号" prop="bizNum">
            <el-input  v-model="bizInfo.bizNum" disabled style="width:100%"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="申请期限" prop="termNum,termUnit">
            ...
            <el-input  v-model="bizInfo.termUnit" disabled style="width: 40%; float: left"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="是否银团" prop="isBankTeamLoan">
            <el-input  v-model="bizInfo.isBankTeamLoan" disabled style="width:100%"></el-input>
          </el-form-item>
        </el-col>
        <!--<el-col :span="12">-->
        ...
        <el-col :span="12">
          <el-form-item prop="whetherBzxzfdk" label="是否个人购买保障性住房" >
            <el-select clearable v-model="bizInfo.whetherBzxzfdk" style="width:100%">
              <el-option v-for="(value,key) in yesOrNoOpts" :key="key" :label="value" :value="key" >
              </el-option>
            </el-select>
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="经办机构" prop="orgNum">
            <el-input  v-model="bizInfo.orgNum" disabled style="width:100%"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="经办人" prop="userNum">
            <el-input  v-model="bizInfo.userNum" disabled style="width:100%"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="申请日期" prop="applyDate">
            <el-input v-model="natural.applyDate" disabled></el-input>
          </el-form-item>
        </el-col>
      </el-form>
    </el-row>
    <el-row>
      <el-col :span="6" :offset="12">
        <el-button size="medium" v-bind:disabled="buttonDisable" type="primary" @click="updateBizApply">{{buttonText}}</el-button>
      </el-col>
    </el-row>
  </div>
</template>
...
<script>
  ...
  import { updateAppBizInfo } from '@/api/csm'
  export default {
    name: "app-biz-info-edit",
    props:{
      info:{},
      bizInfo:{termUnit:'月',isBankTeamLoan:'否'},
      natural:{}
    },
    data(){
      return{
    ...
    methods:{
      updateBizApply:function () {
        this.$refs["updateBizInfoValidate"].validate((valid) => {
          if(valid){
            //访问服务器，返回结果，做判断，提交成功，输入框不可获取焦点，确定和重置按钮不可点击,清楚输入框数据
            this.buttonDisable = true;
            this.buttonText = "提交中";
            let params = Object.assign({}, this.bizInfo, {bizId : this.info.applyId} )
            updateAppBizInfo(params).then(res => {
              if(res && res.data && res.data.code == 200){//返回数据成功
                ...
                this.$message({message: '基本信息保存失败, 错误信息：' + res, type: 'error'})
                console.error('基本信息保存失败, 错误信息：' + res)
              }

...
<script>
  import { getMortgageList,getGuaranteerBySuretyId,deleteMortgageBasicBySuretyId} from '@/api/securitymanagement'
          ...
          pageDef: {
            ...
            tabDef: {
              ...
              tabCols: [
                ...
                {label: "抵质押品占用价值(元)", prop: "totalKhAmt",},
                {label: "本次实际担保债权金额(元)", prop: "suretyAmt",},
                {label: "抵质押率%", prop: "mortgageRate",},
                {label: "抵质押类型", prop: "collType",isFormat: true,enumType:'collTypeCd'},
              ]
            },
            buttons: [
      ...
      methods:{
        ...
        doDelete(row){
          ...
          this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
            ...
            deleteMortgageBasicBySuretyId(row).then(response => {

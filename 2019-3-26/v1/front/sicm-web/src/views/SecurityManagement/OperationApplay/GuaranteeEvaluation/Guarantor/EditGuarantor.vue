        ...
        <el-form el-form label-width="125px"  size="mini" :model="data" label-position="right" :rules="rules" ref="validate" >
          <el-col :span="12">
            <el-form-item label="保证人名称" prop="partyName" class="special-input">
              <el-input :readonly="readOnlyDisable" :disabled="isScan" v-model="data.partyName"></el-input>
              <!--不允许修改的时候再去重新选择保证人-->
          ...
          <template v-if="isNaturalCustomer">
            <el-col :span="12">
              <el-form-item label="证件类型" prop="certType" >
                <el-select :disabled="inputComponentDisable ||isScan"  v-model="data.certType" placeholder="请选择" style="width:100%">
            ...
            <el-col :span="12">
              <el-form-item label="证件号码" prop="certNum" >
                <el-input :readonly="readOnlyDisable":disabled="isScan" v-model="data.certNum" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
          </template>
          <template v-else>
            <el-col :span="12">
              <el-form-item label="营业执照" prop="registrCd" >
                <el-input :readonly="readOnlyDisable" :disabled="isScan" v-model="data.registrCd" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="组织机构代码" prop="orgRegisterCd" >
                <el-input :readonly="readOnlyDisable" :disabled="isScan" v-model="data.orgRegisterCd" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
          </template>
          <el-col :span="12">
            <el-form-item label="信用等级" prop="marketValue" >
              <el-input :readonly="readOnlyDisable" :disabled="isScan" v-model="data.marketValue" style="width:100%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否担保公司" prop="isGuaranteeCompany" >
              <el-select :disabled="inputComponentDisable || isScan"  v-model="data.isGuaranteeCompany" placeholder="请选择" style="width:100%">
          ...
          <el-col :span="12">
            <el-form-item label="币种" prop="currencyCd" >
              <el-select :disabled="inputComponentDisable  || isScan"  v-model="data.currencyCd" placeholder="请选择" style="width:100%">
          ...
          <template v-if="isGuaranteeCorporation">
            <el-col :span="12">
              <el-form-item label="担保额度起期" prop="beginDate" >
                <el-date-picker :editable="false" :disabled="isScan" :readonly="readOnlyDisable" format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="data.beginDate" type="date" placeholder="选择日期" style="width:100%"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="担保额度止期" prop="endDate" >
                <el-date-picker :editable="false" :disabled="isScan" :readonly="readOnlyDisable" format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="data.endDate" type="date" placeholder="选择日期" style="width:100%"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="授信额度" prop="creditAmount" >
                <el-input :readonly="readOnlyDisable" :disabled="isScan" v-model="data.creditAmount" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="单户总额" prop="simpleAmount" >
                <el-input :readonly="readOnlyDisable" :disabled="isScan" v-model="data.simpleAmount" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="保证金存储方式" prop="accnoWay" >
                <el-checkbox-group v-model="data.accnoWay" :disabled="isScan">
            ...
            <el-col :span="12">
              <el-form-item label="合作状态" prop="creditStatus" >
                <el-select :disabled="inputComponentDisable || isScan"  v-model="data.creditStatus" placeholder="请选择" style="width:100%">
            ...
            <el-col :span="12">
              <el-form-item label="性质" prop="creditType" >
                <el-select :disabled="inputComponentDisable || isScan"  v-model="data.creditType" placeholder="请选择" style="width:100%">
            ...
            <el-col :span="12">
              <el-form-item label="责任分担比例" prop="creditApport" >
                <el-input :readonly="readOnlyDisable" :disabled="isScan" v-model="data.creditApport" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="预用担保金额(元)" prop="useAmt" >
                <el-input :disabled="inputComponentDisable|| isScan" v-model="data.useAmt" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="已担保金额(元)" prop="usedAmt" >
                <el-input :disabled="inputComponentDisable|| isScan" v-model="data.usedAmt" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="可用保证金额(元)" prop="aviAmt" >
                <el-input :disabled="inputComponentDisable || isScan" v-model="data.aviAmt" style="width:100%"></el-input>
              </el-form-item>
            </el-col>
          </template>
          <el-col :span="12">
            <el-form-item label="申请担保金额(元)" prop="suretyAmt" >
              <el-input  :disabled="isScan" v-model="data.suretyAmt" style="width:100%"></el-input>
            </el-form-item>
          </el-col>
        </el-form>
      </el-row>
...
<script>
  import {getGuaranteerBySuretyId,selectGuaranteeConZh,getPartyInfoByPartyId,updateGuaranteeApplyTbGrtGuaranteer,queryCompanyStatus} from '@/api/securitymanagement'
  ...
  import customerTable from './CustomerTable'
    export default {
      ...
      beforeMount(){
        if(this.info.isScan){ //只是查看
          this.isScan = true;
        }
        getGuaranteerBySuretyId(this.info).then(response=>{
          if(response.data.flag == enums.stateCode.flag.success) {//返回数据成功
            ...
            this.data.isGuaranteeCompany = response.data.grtGuaranteeBasic.isGuaranteeCompany;
            this.data.currencyCd = response.data.grtGuaranteeBasic.currencyCd;
            this.data.suretyId = response.data.grtGuaranteeBasic.suretyId;
            this.data.usableGuaranteeLimit = response.data.grtGuaranteeBasic.usableGuaranteeLimit;
            this.data.suretyAmt = response.data.grtGuaranteeBasic.suretyAmt;
            ...
            if(response.data.isZYDBGS=='true'){//是否担保公司
              ...
              this.data.aviAmt = Number(this.data.creditAmount)- Number(this.data.useAmt)+Number(response.data.grtGuaranteeBasic.suretyAmt);
              this.data.accnoWay = response.data.grtGuaranteeBasic.accnoWay.split(',');
              var listquery = {};
              listquery.pageSize=10;
              listquery.pageNum=1;
              this.doPageQuery(listquery);
            } else{
              this.data.guaranteeForm = response.data.grtGuaranteeBasic.guaranteeForm;
      ...
      methods:{
                ...
                if(this.bizHappenType !="06"){
                  ...
                  queryCompanyStatus(stopJson).then(response => {
                    ...
                    if(response.data.flag == enums.stateCode.flag.success){//
                      ...
                      //未使用同步请求
                      updateGuaranteeApplyTbGrtGuaranteer(this.data).then(req =>{
        ...
        getMsg(row){//选择客户信息确定回调函数
          ...
          this.data.guarantorPartyId = row.partyId;
          this.buttonDisable = true;
          this.buttonText = "";
          this.isLoading = true;
          getPartyInfoByPartyId(row).then(response => {
            if(response.data.flag == enums.stateCode.flag.success){//返回数据成功
              this.data.partyId = response.data.data.partyId;
              this.data.partyName = response.data.data.partyName;
              if(response.data.data.partyTypeCd=='02'){//自然人客户
                this.isNaturalCustomer = true;
                this.data.certNum = response.data.data.certNum;
...
<style lang="scss">
  ...
  .edit-guarantor .el-form-item__label{
    font-size: 13px !important;
  }
  .edit-guarantor .special-input .el-input{
    width: calc(100% - 50px );
    float: left!important;
  }
  .edit-guarantor .special-button{
    float:left!important;

...
@Service
@Transactional
public class BizDtlCreditReckonVo {
...
//	public String getStatus(HashMap<String, Object> map) {
//		return (String) map.get("CREDIT_STATUS");
//	}
	
	@SuppressWarnings("unchecked")
	public HashMap<String, Object> getCreditMap(String bizDtlId) {
		List<HashMap<String,Object>> datas = csmCreditReckonMapper.getBizDtlCredit(bizDtlId);
		
		//Object[] datas = DatabaseExt.queryByNamedSql(DBUtil.DB_NAME_DEF, "com.bos.pub.credit.reckon.CreditReckonSql.getBizDtlCredit", bizDtlId);

...
/**公司合同信息查询结果集*/
public class CompanyContractInfoResult {
	private String orgNum;
	private String userNum;
	private String xyContractNum;
	...
	private String xyId;
	private String yqts;
	private String dft_itr_in;
	private String dft_itr_out;
	private String fljg;
	...
	public String getXyContractNum() {
		return xyContractNum;
	}
	public void setXyContractNum(String xyContractNum) {
		this.xyContractNum = xyContractNum;
	}
	...
	public String getDft_itr_in() {
		return dft_itr_in;
	}
	public void setDft_itr_in(String dft_itr_in) {
		this.dft_itr_in = dft_itr_in;
	}
	public String getDft_itr_out() {
		return dft_itr_out;
	}
	public void setDft_itr_out(String dft_itr_out) {
		this.dft_itr_out = dft_itr_out;
	}

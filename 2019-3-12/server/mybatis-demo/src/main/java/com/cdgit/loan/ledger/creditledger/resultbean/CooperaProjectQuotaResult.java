...
/**合作项目额度使用明细结果集*/
public class CooperaProjectQuotaResult {
	...
	public String getSummaryNum2() {
		return summaryNum2;
	}
	public void setSummaryNum2(String summaryNum2) {
		this.summaryNum2 = summaryNum2;
	}

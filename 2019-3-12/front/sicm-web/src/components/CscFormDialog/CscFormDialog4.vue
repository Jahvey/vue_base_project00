<template>
  <div>
    <el-dialog :title="pageDef.title" :visible.sync="pageDef.dialogFormVisible" :before-close="handleClose" :fullscreen="true">
      ...
      <div class="top">
        <!-- 顶部布局的tab标签-->
        <csc-el-csmnp-tabs-tree :pageDef="pageDef">

        </csc-el-csmnp-tabs-tree>
      </div>
...
import CscElTabsNaturalPersonTree from "../CscElTabs/CscElTabsNaturalPersonTree";
export default {
  data() {
    return{
      activeName2: 'first'
  ...
  created: function() {
        ...
        console.log("this.dig4..................."+JSON.stringify(this.pageDef))

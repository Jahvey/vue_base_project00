...
<script>
  // 从合同信息之保证合同 http://192.168.1.105:7001/default/crt/con_grt/con_bzr_list.jsp
    ...
    data: function() {
      return {
        ...
        entity: {// 这个就相当于一个form表单，在这里定义之后可以直接在上面去使用 entity.属性名
          data: [
            {
              SUBCONTRACT_NUM: 'HT201810263213729',
              PARTY_NAME: '保证合同',
              IF_TOP_SUBCON: '是',
              BZ: '人民币',
              SUBCONTRACT_AMT: 2000.00,
              SURETY_AMT: 1000.00,
              OPERATION_TYPE: '什么类型？'
            }
          ]
        ...
        pageDef: {
          ...
          tabDef: {
            ...
            // 表格字段定义
            tabCols: [
              { label: '保证合同编号', prop: 'SUBCONTRACT_NUM', isSort: true },
              { label: '保证人名称', prop: 'PARTY_NAME', isSort: true },

...
public class CsmTbBizApprove {
	...
	public String toString() {
		return "CsmTbBizApprove [approveId=" + approveId + ", bizNum=" + bizNum + ", bizType=" + bizType
				...
				+ crdId + ", creditMode=" + creditMode + ", busiPartner=" + busiPartner + ", whetherBzxzfdk="
				+ whetherBzxzfdk + ", getBusiPartner()=" + getBusiPartner() + ", getWhetherBzxzfdk()="
				+ getWhetherBzxzfdk() + ", getApproveId()=" + getApproveId() + ", getBizNum()=" + getBizNum()
				+ ", getBizType()=" + getBizType() + ", getLowRiskBizType()=" + getLowRiskBizType()
				+ ", getApplyModeType()=" + getApplyModeType() + ", getBizHappenType()=" + getBizHappenType()
				+ ", getOrgNum()=" + getOrgNum() + ", getUserNum()=" + getUserNum() + ", getPartyId()=" + getPartyId()
				+ ", getBusinessProduct()=" + getBusinessProduct() + ", getProductType()=" + getProductType()
				+ ", getAmountType()=" + getAmountType() + ", getCsmCrdLevel()=" + getCsmCrdLevel()
				+ ", getApprovalNum()=" + getApprovalNum() + ", getBecomeEffectiveMark()=" + getBecomeEffectiveMark()
				+ ", getOriginalApproveId()=" + getOriginalApproveId() + ", getIsBankTeamLoan()=" + getIsBankTeamLoan()
				+ ", getPolicyDecisionIdea()=" + getPolicyDecisionIdea() + ", getPolicyDecisionNum()="
				+ getPolicyDecisionNum() + ", getApplyTypeMark()=" + getApplyTypeMark() + ", getApproveConclusion()="
				+ getApproveConclusion() + ", getEndOrgNum()=" + getEndOrgNum() + ", getIfDataMove()=" + getIfDataMove()
				+ ", getApplyId()=" + getApplyId() + ", getBizHappenNature()=" + getBizHappenNature()
				+ ", getIsGreenLoan()=" + getIsGreenLoan() + ", getLoanType()=" + getLoanType() + ", getBizTypeFlag()="
				+ getBizTypeFlag() + ", getGuarantyType()=" + getGuarantyType() + ", getTermUnit()=" + getTermUnit()
				+ ", getApplyDate()=" + getApplyDate() + ", getTermNum()=" + getTermNum() + ", getRmbAmt()="
				+ getRmbAmt() + ", getCrdId()=" + getCrdId() + ", getCreditMode()=" + getCreditMode()
				+ ", getHandingDate()=" + getHandingDate() + ", getCreateTime()=" + getCreateTime()
				+ ", getUpdateTime()=" + getUpdateTime() + ", getLoanInspectionFre()=" + getLoanInspectionFre()
				+ ", getValidDate()=" + getValidDate() + ", getEndDate()=" + getEndDate() + ", getBoUse()=" + getBoUse()
				+ ", getNoUse()=" + getNoUse() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()

...
public class CsmConFlagInfo {
    ...
    private String greenLoan;				//是否绿色信贷(XD_0002)
    ...
    private String greenLoanUse;			//绿色贷款的贷款用途(XD_DKSQLX0002)

    private String greenRiskType;			//环境、安全等重大风险企业类别(XD_DKSQLX0001)

    private String greenRiskDetail;			//风险明细类型，根据riskInfo(XD_SXYW0211)信息得出，分01(XD_DKSQLX0003)、02(XD_DKSQLX0004)、04(XD_DKSQLX0005)

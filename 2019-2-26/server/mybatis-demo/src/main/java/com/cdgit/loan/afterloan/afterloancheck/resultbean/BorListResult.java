package com.cdgit.loan.afterloan.afterloancheck.resultbean;
/**1.贷后首次检查客户列表 2.可日常检查客户列表*/
public class BorListResult {
	...
	public String getWarningLevelCd() {
		return warningLevelCd;
	}
	public void setWarningLevelCd(String warningLevelCd) {
		this.warningLevelCd = warningLevelCd;
	}
	...
	public void setFinishDes(String finishDes) {

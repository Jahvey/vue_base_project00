...
public class ChOmOrganization {
	...
	public boolean equals(Object that) {
		...
		ChOmOrganization other = (ChOmOrganization) that;
		return (this.getOrgid() == null ? other.getOrgid() == null : this.getOrgid().equals(other.getOrgid()))
				...
				&& (this.getOrglevel() == null ? other.getOrglevel() == null
						: this.getOrglevel().equals(other.getOrglevel()))
				&& (this.getOrgdegree() == null ? other.getOrgdegree() == null
						: this.getOrgdegree().equals(other.getOrgdegree()))
				...
				&& (this.getOrgaddr() == null ? other.getOrgaddr() == null
						: this.getOrgaddr().equals(other.getOrgaddr()))
				&& (this.getZipcode() == null ? other.getZipcode() == null
						: this.getZipcode().equals(other.getZipcode()))
				&& (this.getManaposition() == null ? other.getManaposition() == null
						: this.getManaposition().equals(other.getManaposition()))
				&& (this.getManagerid() == null ? other.getManagerid() == null
						: this.getManagerid().equals(other.getManagerid()))
				&& (this.getOrgmanager() == null ? other.getOrgmanager() == null
						: this.getOrgmanager().equals(other.getOrgmanager()))
				&& (this.getLinkman() == null ? other.getLinkman() == null
						: this.getLinkman().equals(other.getLinkman()))
				&& (this.getLinktel() == null ? other.getLinktel() == null
						: this.getLinktel().equals(other.getLinktel()))
				...
				&& (this.getUpdator() == null ? other.getUpdator() == null
						: this.getUpdator().equals(other.getUpdator()))
				&& (this.getSortno() == null ? other.getSortno() == null : this.getSortno().equals(other.getSortno()))
				&& (this.getIsleaf() == null ? other.getIsleaf() == null : this.getIsleaf().equals(other.getIsleaf()))
				&& (this.getSubcount() == null ? other.getSubcount() == null
						: this.getSubcount().equals(other.getSubcount()))
				&& (this.getRemark() == null ? other.getRemark() == null : this.getRemark().equals(other.getRemark()))
				&& (this.getBuno() == null ? other.getBuno() == null : this.getBuno().equals(other.getBuno()))
				&& (this.getAuditbankno() == null ? other.getAuditbankno() == null
						: this.getAuditbankno().equals(other.getAuditbankno()))
				&& (this.getPaymentsysno() == null ? other.getPaymentsysno() == null
						: this.getPaymentsysno().equals(other.getPaymentsysno()))
				&& (this.getParentorgcode() == null ? other.getParentorgcode() == null
						: this.getParentorgcode().equals(other.getParentorgcode()))
				&& (this.getIsteam() == null ? other.getIsteam() == null : this.getIsteam().equals(other.getIsteam()))
				&& (this.getIsTradeArea() == null ? other.getIsTradeArea() == null
						: this.getIsTradeArea().equals(other.getIsTradeArea()))
				&& (this.getLegOrg() == null ? other.getLegOrg() == null : this.getLegOrg().equals(other.getLegOrg()))
				&& (this.getFinancialnum() == null ? other.getFinancialnum() == null
						: this.getFinancialnum().equals(other.getFinancialnum()))
				&& (this.getFinancialorgcode() == null ? other.getFinancialorgcode() == null
						: this.getFinancialorgcode().equals(other.getFinancialorgcode()))
				&& (this.getNonlocalcode() == null ? other.getNonlocalcode() == null
						: this.getNonlocalcode().equals(other.getNonlocalcode()))
				&& (this.getOrgcreditcode() == null ? other.getOrgcreditcode() == null
						: this.getOrgcreditcode().equals(other.getOrgcreditcode()))
				&& (this.getBankno() == null ? other.getBankno() == null : this.getBankno().equals(other.getBankno()))
				&& (this.getNationalityCd() == null ? other.getNationalityCd() == null
						: this.getNationalityCd().equals(other.getNationalityCd()))
				&& (this.getProvinceCd() == null ? other.getProvinceCd() == null
						: this.getProvinceCd().equals(other.getProvinceCd()))
				...
				&& (this.getStreetAddress() == null ? other.getStreetAddress() == null
						: this.getStreetAddress().equals(other.getStreetAddress()))
				&& (this.getRegAdministrativeDivisions() == null ? other.getRegAdministrativeDivisions() == null
						: this.getRegAdministrativeDivisions().equals(other.getRegAdministrativeDivisions()))
				&& (this.getOrgSeal() == null ? other.getOrgSeal() == null
						: this.getOrgSeal().equals(other.getOrgSeal()))
				&& (this.getParentorgname() == null ? other.getParentorgname() == null
						: this.getParentorgname().equals(other.getParentorgname()));
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((getRegAdministrativeDivisions() == null) ? 0 : getRegAdministrativeDivisions().hashCode());

      ...
      <template v-for="tabCol in pageDef.tabDef.tabCols">
        ...
        <template v-else-if="tabCol.isLink">
          <el-table-column :label="tabCol.label" :prop="tabCol.prop" :sortable="tabCol.isSort" :width="135"
            ...
            {{appendRequestUrlParam(tabCol.prop,scope.row[tabCol.prop],requestUrlParam,3)}}
...
export default {
  ...
  methods: {
    appendRequestUrlParam(key,value,requestUrlParam,num){
      //console.log(num)
      //console.log(key+"..."+value)
      //console.log(requestUrlParam.substring(0,5)=='begin')
     // console.log(requestUrlParam.substring(0,5))
      var count=0;
     ...
     // return requestUrlParam  //can't return 
    },

    getRequestUrlParams2(val){
      //val=''
      val+='&mmm'
      this.getRequestUrlParams(val)
    },

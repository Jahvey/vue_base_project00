<template>
  <div>
    ...
    <csc-form-dialog2 :pageDef="pageDef" :form="form" @doSave="doSave" @doCancel="doCancel">
...
<script>
  import CscFormDialog2 from "@/components/CscFormDialog/CscFormDialog2"
    ...
    data() {
      return {
        ...
        pageDef: {
          ...
          //动态传入标签数组
          tabPanes:[
            {tabName:'标签一',name:'first',url:'/user/ManyTable',components:["",""],param:{"contractNum":"dddd","customerNum":"321"}},
            {tabName:'标签二',name:'second',url:'/user/ManyTable',components:["",""],param:{"contractNum":"dddd","customerNum":"321"}},
            {tabName:'标签三',name:'third',url:'/user/ManyTable',components:["",""],param:{"contractNum":"dddd","customerNum":"321"}}
          ],

...
<!--              <el-radio :label="01">公司客户</el-radio>
              <el-radio :label="02">自然人客户</el-radio>
              <el-radio :label="04">联保客户</el-radio>
              <el-radio :label="05">同业客户</el-radio>
              <el-radio :label="06">统一授信客户</el-radio>
              <el-radio :label="07">合作中介客户</el-radio>-->
              <el-radio :label="1">公司客户</el-radio>
              <el-radio :label="2">自然人客户</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <!--客户名全称开始-->
        <el-col :span="24">
          <el-form-item label="客户名全称" prop="partyName">
            <el-popover
              placement="top-start"
              width="900"
              ...
              <el-input disabled="true" v-model="grtCollateralInfo.partyName" slot="reference" ></el-input>
            </el-popover>
          </el-form-item>
        </el-col>
        <!--客户名全称结束-->
    ...
    <el-dialog
      ...
      <el-row>
        ...
        <el-col :span="21">
          <!--动态组件-->
          <keep-alive>
            <compoment v-bind:is="currentView" v-bind:grtCollateralInfo="grtCollateralInfo"></compoment>
          </keep-alive>
        </el-col>
      </el-row>
    </el-dialog>

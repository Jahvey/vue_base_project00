<template>
  <div>
    <el-dialog :title="pageDef.title" :visible.sync="pageDef.dialogFormVisible" v-if='pageDef.dialogFormVisible'
               :before-close="handleClose" :fullscreen="true">


      <div class="top">
        <!-- 顶部布局的tab标签-->
        <csc-el-tabs-tree :tabsDef="pageDef">
...
import CscElTabsTree from "../CscElTabs/CscElTabsTree";
export default {
  data() {
    return{
      activeName2: 'first'

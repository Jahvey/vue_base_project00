...
public class ChTbCrdThirdPartyLimit {
    ...
    private Integer longestLoanTerm;
    ...
    public void setGuarantTerm(Integer guarantTerm) {
    ...
    public Integer getLongestLoanTerm() {
        return longestLoanTerm;
    }

    public void setLongestLoanTerm(Integer longestLoanTerm) {
    ...
    public boolean equals(Object that) {
        ...
        ChTbCrdThirdPartyLimit other = (ChTbCrdThirdPartyLimit) that;

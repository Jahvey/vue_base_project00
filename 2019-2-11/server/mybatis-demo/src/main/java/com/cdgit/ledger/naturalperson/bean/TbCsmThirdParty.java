...
public class TbCsmThirdParty {
    ...
    private Date teamworkStart;

    private Date teamworkEnd;
    ...
    public void setContactAdress(String contactAdress) {
        this.contactAdress = contactAdress == null ? null : contactAdress.trim();
    }
    ...
    public void setBusinessCd(String businessCd) {
        this.businessCd = businessCd == null ? null : businessCd.trim();
    }
    ...
    public Date getTeamworkStart() {
        return teamworkStart;
    }

    public void setTeamworkStart(Date teamworkStart) {
        this.teamworkStart = teamworkStart;
    }

    public Date getTeamworkEnd() {
        return teamworkEnd;
    }

    public void setTeamworkEnd(Date teamworkEnd) {
        this.teamworkEnd = teamworkEnd;
    }
    ...
    public boolean equals(Object that) {
        ...
        TbCsmThirdParty other = (TbCsmThirdParty) that;
        return (this.getPartyId() == null ? other.getPartyId() == null : this.getPartyId().equals(other.getPartyId()))
            ...
            && (this.getContactAdress() == null ? other.getContactAdress() == null : this.getContactAdress().equals(other.getContactAdress()))
            ...
            && (this.getBusinessCd() == null ? other.getBusinessCd() == null : this.getBusinessCd().equals(other.getBusinessCd()))
            && (this.getBusinessEndDate() == null ? other.getBusinessEndDate() == null : this.getBusinessEndDate().equals(other.getBusinessEndDate()))
            && (this.getTeamworkStart() == null ? other.getTeamworkStart() == null : this.getTeamworkStart().equals(other.getTeamworkStart()))
            && (this.getTeamworkEnd() == null ? other.getTeamworkEnd() == null : this.getTeamworkEnd().equals(other.getTeamworkEnd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getContactAdress() == null) ? 0 : getContactAdress().hashCode());
        result = prime * result + ((getContactPhone() == null) ? 0 : getContactPhone().hashCode());
        result = prime * result + ((getThirdCustTypeCd() == null) ? 0 : getThirdCustTypeCd().hashCode());
        result = prime * result + ((getBusinessCd() == null) ? 0 : getBusinessCd().hashCode());
        result = prime * result + ((getBusinessEndDate() == null) ? 0 : getBusinessEndDate().hashCode());
        result = prime * result + ((getTeamworkStart() == null) ? 0 : getTeamworkStart().hashCode());
        result = prime * result + ((getTeamworkEnd() == null) ? 0 : getTeamworkEnd().hashCode());

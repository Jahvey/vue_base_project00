  ...
  export default {
        ...
        pageDef: {
          ...
          queryDef: {
            ...
            queryCols: [
              ...
              { label: '还款日期', inputType: 'date', modelName: 'rcvDate' }
            ]
          },
          tabDef: {
            ...
            tabCols: [
              ...
              { label: '还款日期', prop: 'rcvDate', isSort: true },
              { label: '归还本金', prop: 'hbje', isSort: true },
              { label: '归还利息', prop: 'sum1', isSort: true },
              { label: '归还罚息', prop: 'sum2', isSort: true },
              { label: '归还本息合计', prop: 'sum3', isSort: true },
    ...
    methods: {
      doPageQuery(listQuery) {
        this.queryDetailedHistory(listQuery)
      },

      queryDetailedHistory(listQuery) {
        queryDetailedHistory(listQuery).then(response => {

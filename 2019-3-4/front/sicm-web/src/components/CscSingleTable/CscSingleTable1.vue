  ...
  <div class="app-container">
    ...
    <el-table  :data="entity.data" highlight-current-row v-loading="listLoading" @selection-change="selectionChange"
      ...
      <template v-for="tabCol in pageDef.tabDef.tabCols">
        ...
        <!-- 2018-11-22 加入超链接 待测试-->
        <template v-else-if="tabCol.isHref">
          <el-table-column :label="tabCol.label" :prop="tabCol.prop" :sortable="tabCol.isSort" :widht="tabCol.width"
                           header-align="center" align="center" :show-overflow-tooltip="tabCol.isOverflow">
            <template slot-scope="scope">

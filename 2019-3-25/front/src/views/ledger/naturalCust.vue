...
<script>
  ...
  import {queryNaturalPerson} from '@/api/ledger'
  ...
  export default {
        ...
        pageDef: {
          ...
          queryDef: {
            ...
            queryCols: [
              ...
              { label: '是否农户', inputType: 'select', modelName: 'isFarmer',enumType:'isGuard' }
            ]
          },
          tabDef: {
            ...
            tabCols: [
              ...
              { label: '是否农户', prop: 'isFarmer', isSort: true,isFormat: true,enumType:'isGuard' },
    ...
    methods: {
      doPageQuery(listQuery) {
        this.queryNaturalPerson(listQuery)
      },

      queryNaturalPerson(listQuery) {
        queryNaturalPerson(listQuery).then(response => {

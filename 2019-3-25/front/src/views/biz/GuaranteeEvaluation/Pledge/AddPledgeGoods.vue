<template>
  <div class="add-pledge-goods">
    <el-container>
      <el-aside width="50%">
        <el-row>
          <p class="mortgage-title">选择质押信息</p>
        </el-row>
        <el-row>
      ...
      <el-main>
        <el-row>
          <p class="mortgage-title">补填质押信息</p>
        </el-row>
        <el-row>
    ...
    export default {
          ...
          pageDef: {
            ...
            tabDef: {
              ...
              tabCols: [
                ...
                {label: "抵质押物名称", prop: "suretyName"},
                {label: "抵质押物类型", prop: "sortType",isFormat: true,enumType:'CollateralStatusCd'},
                {label: "币种", prop: "currencyCd",isFormat: true,enumType:'currencyCd'},
                {label: "抵质押物认定价值(元)", prop: "marketValue",},
                {label: "已设定担保额(元)", prop: "usedAmt",},
              ]
            },
            buttons: [
      ...
      methods:{
        ...
        choose(row){//选择
          ...
          this.data.partyId = row.partyId;
          this.data.partyName = row.partyName;
          this.data.suretyName = row.suretyName;
          this.data.currencyCd = row.currencyCd;
          this.data.marketValue = row.marketValue;
          this.data.usedAmt = row.usedAmt;
          this.data.collType = row.collType;
          this.data.suretyNo = row.suretyNo;
          this.data.suretyId = row.suretyId;
          this.data.sortType = row.sortType;
          this.data.assessValue = row.assessValue;
          this.data.ifOtherCommon = row.ifOtherCommon;
          this.data.mybankSetValue = row.mybankSetValue;
        },
        comfirm(){
...
<style>
  .add-pledge-goods .el-aside {
    border-right: 1px solid #cccccc;
  }
  .add-pledge-goods .mortgage-title{
  ...
  .add-pledge-goods .app-container{
    padding:0px 10px;
  }
  .add-pledge-goods .el-main{
    padding: 0px;
  }
</style>

...
<script>
  import { updateGuaranteeApplyTbGrtCreditsafe,getTbGrtCreditsafeBySuretyId} from '@/api/securitymanagement'
  import enums from "@/utils/enums"
    export default {
      ...
      beforeMount(){
        ...
        getTbGrtCreditsafeBySuretyId(this.info).then(response =>{
          if(response.data.flag == enums.stateCode.flag.success) {//
            //this.data.userNum = response.data.grtGuaranteeBasic.userNum;
            //this.data.orgNum = response.data.grtGuaranteeBasic.orgNum;
            this.data.guaranteeType = response.data.grtGuaranteeBasic.guaranteeType;
            this.data.suretyId = response.data.grtGuaranteeBasic.suretyId;
            this.data.partyId = response.data.grtGuaranteeBasic.partyId;
            this.data.guaranteeMoney = response.data.grtCreditsafe.guaranteeMoney;
            this.data.minLossRate = response.data.grtCreditsafe.minLossRate;
            this.data.endDate = response.data.grtCreditsafe.endDate;
            this.data.effectiveDate = response.data.grtCreditsafe.effectiveDate;
            this.data.creditLimit = response.data.grtCreditsafe.creditLimit;
            this.data.currencyCd = response.data.grtCreditsafe.currencyCd;
            this.data.ndemnityNum = response.data.grtCreditsafe.ndemnityNum;
            this.data.policyNum = response.data.grtCreditsafe.policyNum;
            this.data.insurer = response.data.grtCreditsafe.insurer;
            this.data.policyHolder = response.data.grtCreditsafe.policyHolder;
            this.data.beneficiary = response.data.grtCreditsafe.beneficiary;
            this.buttonText="提交";
            ...
            this.$message({
              message: '初始化信用保险信息失败！'+JSON.stringify(response.data),
              type: 'error'
            });
          }
          if(this.info.isScan){
      ...
      data(){
        return{
          ...
          data:{
            ...
            suretyId:this.info.suretyId,//业务id
          },
          rules:{
            policyHolder:[
              {
        ...
        comfirm(){
          this.$refs["validate"].validate((valid) => {
            if(valid){
              ...
              this.isLoading=true;
              this.inputComponentDisable=true;
              updateGuaranteeApplyTbGrtCreditsafe(this.data).then(response =>{
                if(response.data.flag == enums.stateCode.flag.success){//
